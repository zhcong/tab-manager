...
4. **Filter Tabs**: Open settings to configure URL keyword filters

5. **Organize**: Hover over window labels to rename groups, use delete buttons to remove records

## Privacy

All data is stored locally in your Chrome browser. No user data is collected or uploaded.
